    ...
    <div className="py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-6">
          ...
          {/* Tabs */}
          <div className="flex items-center gap-0 rounded-full p-1 w-full" style={{ backgroundColor: '#2a2a2a' }}>
      ...
      <Dialog open={showPrivateDialog} onOpenChange={setShowPrivateDialog}>
        <DialogContent className="max-w-md border" style={{ backgroundColor: '#262626', borderColor: '#404040' }}>
          <DialogHeader>
